...
abstract class $RoomModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String apartmentId, String name, DateTime createdAt});
}
...
class _$RoomModelImpl implements _RoomModel {
  ...
  @override
  String toString() {
    return 'RoomModel(id: $id, apartmentId: $apartmentId, name: $name, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, apartmentId, name, createdAt);
...
abstract class _RoomModel implements RoomModel {
  const factory _RoomModel(
      ...
      required final DateTime createdAt}) = _$RoomModelImpl;
